...
class UserController extends Controller
{
    ...
    public function userLogin(Request $request, uploadFileRequest $uploadFileRequest)
    {
        $request->validate([
    ...
    public function verifiedOtp(Request $request)
    {
        ...
        $currentTime = time();
        $otpValidity = 90 + 5; // 90 seconds + 5 seconds buffer

        if ($currentTime < $otpTime || $otpTime < $currentTime - $otpValidity) {
